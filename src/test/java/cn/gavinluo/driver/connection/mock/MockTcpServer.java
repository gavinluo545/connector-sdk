...
import cn.gavinluo.driver.connection.message.ExampleRequestPrincipal;
...
@Slf4j
public class MockTcpServer extends AbstractTcpServer<ExampleResponseMessage, ExampleRequestMessage> {
    public MockTcpServer(TcpServerConfig<ExampleResponseMessage, ExampleRequestMessage> config) {
        super(config);
    }
...
//        }
    ...
    private static ExampleResponseMessage getExampleResponseMessage(ExampleRequestMessage msg) {
        ...
        ConcurrentHashMap<Integer, Integer> ioaValues = new ConcurrentHashMap<>(ioas.size());
